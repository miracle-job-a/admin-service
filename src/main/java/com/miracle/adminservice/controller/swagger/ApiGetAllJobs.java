...
@Operation(summary = "전체 직무 조회", description = "DB에 등록된 전체 직무를 조회하여 반환합니다.",
        responses = {
                @ApiResponse(responseCode = "200",
                        ...
                        content = @Content(
                                ...
                                examples = {
                                        @ExampleObject(
                                                name = "성공",
                                                value = "{\"httpStatus\": 200, \"message\": \"전체 직무 조회 성공\", \"data\": List<JobResponseDto> }"),
                                },
                                schema = @Schema(implementation = SuccessApiResponse.class)
                        )),
        })
public @interface ApiGetAllJobs {
}
